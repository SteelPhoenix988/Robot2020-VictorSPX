...
public class Robot extends TimedRobot {
  ...
  WPI_VictorSPX m_leftOne, m_leftTwo, m_rightOne, m_rightTwo;
  ...
  public void robotInit() {
    ...
    m_leftOne = new WPI_VictorSPX(0);
    m_leftTwo = new WPI_VictorSPX(1);

    m_rightOne = new WPI_VictorSPX(2);
    m_rightTwo = new WPI_VictorSPX(4);
